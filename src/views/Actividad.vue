  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Desarrollo de aplicaciones nativas para Android
        p.mb-4 Comprender los conceptos fundamentales en la creación de aplicaciones nativas para la plataforma Android.
